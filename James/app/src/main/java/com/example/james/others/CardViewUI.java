...
import com.example.james.RecyclerView.CommonViewHolder;
import com.example.james.RecyclerView.MyRecyclerAdapter;
import com.example.james.weixinContact.Person;

import java.util.ArrayList;

public class CardViewUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyRecyclerAdapter mAdapter = new MyRecyclerAdapter<Person>(this, R.layout.item_cardview, mData) {
            @Override
